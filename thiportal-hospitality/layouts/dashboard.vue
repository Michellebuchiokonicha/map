        ...
        data(){
            return{
                ...
                app_menu: [
                   ...
                   {icon:'mdi-lan-connect', text:'All Application Form(s)',link:'/dashboard/application'},
                  //  {icon:'mdi-home-flood', text:'Mortgage',link:'/mortgage'},
                   {icon:'mdi-file-document-outline', text:'My Profile',link:'/dashboard/preview'},
