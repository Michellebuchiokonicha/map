<template>
    <div>
      <breadcrumb page="Start New Application">
        ...
        <v-container>
          <v-card rounded class="mortgage-form">
            <mortgage-form-title left="Stucent id" right="Personal Details">
               ...
               <form >
                ...
                <div class="content" v-if="step===2">
                    <div class="view">
                      <v-row class="mb-8">
                          <v-col class="col-12" md="12">
                               <p>Edit Details | Personal Info</p>
                          </v-col>
                          <v-col class="col-12" md="12">
                               <h3>Hello Mimi! It is great having you headers_3</h3>
                          </v-col>
                          <v-col class="col-12" md="6">
                              <div class="mg-top">
