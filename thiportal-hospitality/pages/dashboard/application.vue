      ...
      <breadcrumb page="My Data">
           ...
           <v-container>
              <v-card elevation="0" class="mt-1">
                        <v-card-title>
                            <h5 class="upload">All Applications</h5>
                        </v-card-title>
                        <v-card-subtitle>
                            <p class="upload-subtitle">Applications</p>
                        </v-card-subtitle>
                        <v-card-text>
                            ...
                            <v-simple-table>
                                <template v-slot:default>
                                  <thead class="blue lighten-5 blueSleek">
                                    <tr >
                                      <th class="text-left">
                                        s/n
                                      </th>
                                  ...
                                  <tbody>
                                    ...
                                    >
                                      ...
                                      <td>
                                        <v-chip :style="{color: item.is_uploaded==1?'blue':'red'}"
                                            class="ma-2"
                                            :color="item.is_uploaded==1?'blue lighten-4':'red lighten-5'"
                                            >
                                      ...
                                      <td>
                                        <v-file-input style="display:none" :id="item.id.toString()"
                                         ...
                                         <!-- <span class="text-truncate" v-if="">{{current_file_name}}</span> -->
                                          <v-btn icon  v-if="item.is_uploaded !=1" @click="triggerUpload(item)"> <v-icon color="blue">mdi-cloud-upload-outline</v-icon></v-btn>
