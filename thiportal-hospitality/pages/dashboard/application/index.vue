            ...
            <v-col class="col-12" md="12">
               <v-card elevation="0" class="pa-2">
                <v-card-title>
                  ...
                  <ActionButton color="primary" text="Continue Application" height="35px" :block="false" type="button" :action="apply"/>
                </div>
                </v-card-title>
              <v-card-text>
                <v-row>
      ...
      data () {
        return {
          ...
          headers: [
            ...
            { text: 'Ref No', value: 'app_ref',class:"blue lighten-5" },
            { text: 'Property value', value: 'property_value',class:"blue lighten-5" },
            { text: 'Loan value', value: 'loan_amount',class:"blue lighten-5" },
            { text: 'Down payment', value: 'down_payment',class:"blue lighten-5" },
            { text: 'Tenure (Y)', value: 'loan_tenure',class:"blue lighten-5" },
            { text: 'Status', value: 'status',class:"blue lighten-5" },
            { text: 'Action', value: 'action',class:"blue lighten-5" },
          ],
